...
public class lispLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "EMPTY", "VOID", "BOOLEAN", "INTEGER", "FLOAT", "STRING", "OPERATOR", 
			"IDENTIFIER", "GREEDY", "EXPONENT", "HEX_DIGIT", "ESC_SEQ", "OCTAL_ESC", 
			"UNICODE_ESC", "WS", "LINE_COMMENT"
		};
	}
